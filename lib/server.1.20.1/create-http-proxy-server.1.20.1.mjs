...
import { handlePrivateHttpRequest } from "./handle-private-http-request.1.20.1.mjs";

/**
 * @param {{ [authority: string]: string; }} privateHttpProxyServerConfig - { "users.liquipay.de": "127.0.0.1:5000" }
 * @param {(privateHttpConnection: import("./get-private-http-connection.1.20.1.mjs").PrivateHttpConnection, errorMessage: string, status: number) => unknown} handleErrorPrivateHttpConnection
