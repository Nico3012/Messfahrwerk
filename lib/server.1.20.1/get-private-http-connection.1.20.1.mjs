...
import { createPrivateReadStream } from "./create-private-read-stream.1.20.1.mjs";
...
/**
 * @param {import("./create-private-read-stream.1.20.1.mjs").PrivateReadStream} privateReadStream
